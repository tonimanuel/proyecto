...
//utilizamos la funcion para modificar la consola
	$consulta = modificarconsola($conexion,$nombre,$lanzamiento,$precio,$stock,$descripcion,$idconsola,$rutaimagen,$rutalogo);
